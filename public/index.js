...
var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 53, 16, 1805);
    			add_location(li, file, 52, 12, 1784);
    		},
    ...
    const get_noResults_slot_changes = dirty => ({ value: dirty & /*value*/ 64 });
    const get_noResults_slot_context = ctx => ({ value: /*value*/ ctx[6] });
    ...
    function create_if_block(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*filteredOptions*/ ctx[0].length) return 0;
    		return 1;
    	}
    ...
    function create_else_block(ctx) {
    	let current;
    	const noResults_slot_template = /*$$slots*/ ctx[17].noResults;
    	const noResults_slot = create_slot(noResults_slot_template, ctx, /*$$scope*/ ctx[24], get_noResults_slot_context);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (noResults_slot) {
    				if (noResults_slot.p && dirty & /*$$scope, value*/ 16777280) {
    					noResults_slot.p(get_slot_context(noResults_slot_template, ctx, /*$$scope*/ ctx[24], get_noResults_slot_context), get_slot_changes(noResults_slot_template, /*$$scope*/ ctx[24], dirty, get_noResults_slot_changes));
    				}
    			}
    		},
    		i: function intro(local) {
    ...
    // (57:4) {#if filteredOptions.length}
    function create_if_block_1(ctx) {
    	...
    	function autocompleteoptions_filteredOptions_binding(value) {
    		/*autocompleteoptions_filteredOptions_binding*/ ctx[20].call(null, value);
    	}

    	function autocompleteoptions_getOptionText_binding(value) {
    		/*autocompleteoptions_getOptionText_binding*/ ctx[21].call(null, value);
    	}

    	function autocompleteoptions_input_binding(value) {
    		/*autocompleteoptions_input_binding*/ ctx[22].call(null, value);
    	}

    	function autocompleteoptions_direction_binding(value) {
    		/*autocompleteoptions_direction_binding*/ ctx[23].call(null, value);
    	}

    	let autocompleteoptions_props = {
    		setValue: /*setValue*/ ctx[10],
    		getOptionValue: /*getOptionValue*/ ctx[5],
    		close: /*close*/ ctx[8],
    		$$slots: { default: [create_default_slot] },
    		$$scope: { ctx }
    	};

    	if (/*filteredOptions*/ ctx[0] !== void 0) {
    		autocompleteoptions_props.filteredOptions = /*filteredOptions*/ ctx[0];
    	}

    	if (/*getOptionText*/ ctx[4] !== void 0) {
    		autocompleteoptions_props.getOptionText = /*getOptionText*/ ctx[4];
    	}

    	if (/*input*/ ctx[2] !== void 0) {
    		autocompleteoptions_props.input = /*input*/ ctx[2];
    	}

    	if (/*direction*/ ctx[3] !== void 0) {
    		autocompleteoptions_props.direction = /*direction*/ ctx[3];
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*getOptionValue*/ 32) autocompleteoptions_changes.getOptionValue = /*getOptionValue*/ ctx[5];

    			if (dirty & /*$$scope*/ 16777216) {
    				autocompleteoptions_changes.$$scope = { dirty, ctx };
    			}

    			if (!updating_filteredOptions && dirty & /*filteredOptions*/ 1) {
    				updating_filteredOptions = true;
    				autocompleteoptions_changes.filteredOptions = /*filteredOptions*/ ctx[0];
    				add_flush_callback(() => updating_filteredOptions = false);
    			}

    			if (!updating_getOptionText && dirty & /*getOptionText*/ 16) {
    				updating_getOptionText = true;
    				autocompleteoptions_changes.getOptionText = /*getOptionText*/ ctx[4];
    				add_flush_callback(() => updating_getOptionText = false);
    			}

    			if (!updating_input && dirty & /*input*/ 4) {
    				updating_input = true;
    				autocompleteoptions_changes.input = /*input*/ ctx[2];
    				add_flush_callback(() => updating_input = false);
    			}

    			if (!updating_direction && dirty & /*direction*/ 8) {
    				updating_direction = true;
    				autocompleteoptions_changes.direction = /*direction*/ ctx[3];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(57:4) {#if filteredOptions.length}",
    		ctx
    	});
    ...
    // (58:4) <AutoCompleteOptions bind:filteredOptions bind:getOptionText bind:input bind:direction setValue={setValue} getOptionValue={getOptionValue} close={close}>
    function create_default_slot(ctx) {
    	let current;
    	const option_slot_template = /*$$slots*/ ctx[17].option;
    	const option_slot = create_slot(option_slot_template, ctx, /*$$scope*/ ctx[24], get_option_slot_context$1);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (option_slot) {
    				if (option_slot.p && dirty & /*$$scope*/ 16777216) {
    					option_slot.p(get_slot_context(option_slot_template, ctx, /*$$scope*/ ctx[24], get_option_slot_context$1), get_slot_changes(option_slot_template, /*$$scope*/ ctx[24], dirty, get_option_slot_changes$1));
    				}
    			}
    		},
    		i: function intro(local) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(58:4) <AutoCompleteOptions bind:filteredOptions bind:getOptionText bind:input bind:direction setValue={setValue} getOptionValue={getOptionValue} close={close}>",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let if_block = /*isToggled*/ ctx[1] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input_1, file$1, 47, 0, 1176);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor, remount) {
    			...
    			set_input_value(input_1, /*value*/ ctx[6]);
    			insert_dev(target, t, anchor);
    			...
    			dispose = [
    				...
    				listen_dev(input_1, "input", /*onInput*/ ctx[11], false, false, false),
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*value*/ 64 && input_1.value !== /*value*/ ctx[6]) {
    				set_input_value(input_1, /*value*/ ctx[6]);
    			}
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const close = e => {
    		$$invalidate(1, isToggled = false);
    	};

    	const onFocus = e => {
    		$$invalidate(1, isToggled = true);
    	};
    	...
    	function filter() {
    		if (value.length < minLength) $$invalidate(0, filteredOptions = []); else $$invalidate(0, filteredOptions = options.filter(o => matchingFunction(value, getOptionText(o)) && value !== getOptionValue(o)));
    	}
    	...
    	function input_1_input_handler() {
    		value = this.value;
    		($$invalidate(6, value), $$invalidate(16, $$props));
    	}

    	function autocompleteoptions_filteredOptions_binding(value) {
    		filteredOptions = value;
    		$$invalidate(0, filteredOptions);
    	}

    	function autocompleteoptions_getOptionText_binding(value) {
    		getOptionText = value;
    		($$invalidate(4, getOptionText), $$invalidate(16, $$props));
    	}
    	...
    	function autocompleteoptions_direction_binding(value) {
    		direction = value;
    		($$invalidate(3, direction), $$invalidate(16, $$props));
    	}
    	...
    	$$self.$inject_state = $$new_props => {
    		...
    		if ("filteredOptions" in $$props) $$invalidate(0, filteredOptions = $$new_props.filteredOptions);
    		if ("isToggled" in $$props) $$invalidate(1, isToggled = $$new_props.isToggled);
    		if ("input" in $$props) $$invalidate(2, input = $$new_props.input);
    		if ("direction" in $$props) $$invalidate(3, direction = $$new_props.direction);
    		if ("getOptionText" in $$props) $$invalidate(4, getOptionText = $$new_props.getOptionText);
    		if ("getOptionValue" in $$props) $$invalidate(5, getOptionValue = $$new_props.getOptionValue);
    	...
    	$$self.$$.update = () => {
    		 $$invalidate(3, { direction = [DIRECTION.LEFT, DIRECTION.BOTTOM], getOptionText = o => o, getOptionValue = o => o, matchingFunction = (value, optionValue) => optionValue.toLowerCase().startsWith(value.toLowerCase()), options, value = "", minLength = 0, ...nativeProps } = $$props, direction, ($$invalidate(4, getOptionText), $$invalidate(16, $$props)), ($$invalidate(5, getOptionValue), $$invalidate(16, $$props)), ($$invalidate(6, value), $$invalidate(16, $$props)), ($$invalidate(7, nativeProps), $$invalidate(16, $$props)));
    	};
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$2, 10, 0, 158);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
