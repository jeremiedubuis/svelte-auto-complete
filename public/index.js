...
var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 53, 16, 1769);
    			add_location(li, file, 52, 12, 1748);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input_1, file$1, 44, 0, 1123);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function filter() {
    		if (value.length < minLength) $$invalidate(4, filteredOptions = []); else $$invalidate(4, filteredOptions = options.filter(o => matchingFunction(value, getOptionValue(o)) && value !== getOptionValue(o)));
    	}
